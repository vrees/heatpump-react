...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.vrees.heatpump.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.vrees.heatpump.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, de.vrees.heatpump.domain.User.class.getName());
